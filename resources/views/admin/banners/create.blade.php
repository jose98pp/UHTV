                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('location') is-invalid @enderror" id="location" name="location" required>
                                    ...
                                    <option value="portada_top" {{ old('location') == 'portada_top' ? 'selected' : '' }}>Portada - Arriba</option>
                                    <option value="portada_middle" {{ old('location') == 'portada_middle' ? 'selected' : '' }}>Portada - Medio</option>
                                    <option value="sidebar" {{ old('location') == 'sidebar' ? 'selected' : '' }}>Barra Lateral</option>
                                    <option value="footer" {{ old('location') == 'footer' ? 'selected' : '' }}>Pie de Página</option>
